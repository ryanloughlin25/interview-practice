...
class MakingChangeTestCase(unittest.TestCase):
    def test_zero_ways(self):
        self.assertEqual(making_change(1, [2]), [])

    def test_one_way(self):
        self.assertEqual(making_change(3, [3]), [[3]])

    def test_simple(self):
        self.assertEqual(making_change(2, [1,2]), [[1,1], [2]])

    def test_blah(self):
        self.assertEqual(making_change(3, [1,2]), [[1,1,1], [1,2]])
